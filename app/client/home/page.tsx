    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {showSuccess && submittedData ? (
        ...
        <div>
          ...
          {/*
            KEY LOGIC:
            - showPartialForm = true  →  form starts at 'collateral', hides borrower + kin steps
            - showPartialForm = false →  full 4-step form from 'borrower'
            Both cases: the form is ALWAYS rendered (no "already submitted" block hiding it)
          */}
          <LoanForm
            darkMode={darkMode}
